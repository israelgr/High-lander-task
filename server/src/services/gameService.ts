...
export async function createGame(
  ...
  const distanceConfig = await configService.getDistanceConfig();

  const systemDefaults: GameConfig = {
    maxPlayers: distanceConfig.defaultMaxPlayers,
    goalRadiusMin: distanceConfig.goalRadiusMin,
    goalRadiusMax: distanceConfig.goalRadiusMax,
    proximityThreshold: distanceConfig.defaultProximityThreshold,
  };

  const config = { ...systemDefaults, ...partialConfig };
