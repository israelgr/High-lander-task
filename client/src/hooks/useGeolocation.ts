...
import { mockLocationService, isMockLocationEnabled } from '../services/mockLocation';
...
export function useGeolocation(options: UseGeolocationOptions = {}): GeolocationState & {
  ...
  useEffect(() => {
    // Use mock location in development mode
    if (isMockLocationEnabled()) {
      ...
      if (opts.watch) {
        mockLocationService.startWatching();
      }

      return () => {
        unsubscribe();
        mockLocationService.stopWatching();
      };
    }
